    ...
    public partial class SnapShots : ScrollableControl
    {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            for (int index = 1; index < (_numSquares+1); index++)
            {
                ...
                Rectangle textRectInnner = new Rectangle(theRect.X, theRect.Y+9, 68, 45);
                int i = index - 1;
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            if (squareID > 0)
            {
                ...
                if ((((MainPage)this.Parent).mediaManager.currentMedia != null) && (((MainPage)this.Parent).images != null))
                    ((MainPage)this.Parent).mediaManager.currentMedia.setPosition((((MainPage)this.Parent).images[index]).time);
            }
        }
        ...
        public void AddFrame(Frames frame)
        {
            if (frame == null )
                return;
            if(images == null)
                images = new List<Frames>();
