...
namespace Video.Controls
{
    ...
    class DataGridViewColumnSelector
    {
        ...
        private DataGridView mDataGridView2 = null;
        ...
        {
            get { return mDataGridView2; }
            set
            {
               // Set the new DataGridView
                mDataGridView2 = value;
            }
        }
        ...
        public DataGridViewColumnSelector(DataGridView dgv, DataGridView dgv2)
            : this()
        {
            this.DataGridView = dgv;
            this.DataGridView2 = dgv2;
        }
        ...
        void mCheckedListBox_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            mDataGridView2.Columns[e.Index].Visible = (e.NewValue == CheckState.Checked);
        }
    }
}
