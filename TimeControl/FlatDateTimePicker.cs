...
namespace VideoPlayer
{
	...
	{	
		...
		{	
			...
			Graphics gdc = null;
            //if ((m.Msg == 20) || (m.Msg == 14))
            //{
            //    Graphics g = Graphics.FromHwnd(m.HWnd);
            //    g.FillRectangle(new SolidBrush(Color.FromArgb(233, 234, 243)), this.ClientRectangle);
            //    g.Dispose();
            //    //return;
            //}
			switch (m.Msg)
			{
				case WM_NC_PAINT:	
                    ...
                    SendPrintClientMsg();
                    //gdc.FillRectangle(new SolidBrush(Color.FromArgb(233, 234, 243)), this.ClientRectangle);

					SendMessage(this.Handle, WM_PAINT, IntPtr.Zero, 0);
					OverrideControlBorder(gdc);
                    //m.Result = (IntPtr)1;	// indicate msg has been processed
                    m.Result = (IntPtr)0;	// indicate msg has been processed
				...
				case WM_PAINT:	
					...
					OverrideControlBorder(gdc);
                    //gdc.FillRectangle(new SolidBrush(Color.FromArgb(233, 234, 243)), 
                    //    this.ClientRectangle.X+2,
                    //    this.ClientRectangle.Y+2,
                    //    this.ClientRectangle.Width-12,
                    //    this.ClientRectangle.Height+6);
